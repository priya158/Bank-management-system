...
def new_cust():
    ...
    print('New User Account Created on',x)
    print(f'Welcome {customer.name} to State Bank of India. {customer.cust_acc_num} is your account number')
...
def login():
    ...
    if account_no in customer_dict.keys() and account_pin == customer_dict[account_no].pin :
        ...
        print(f'\n{customer_dict[account_no].name} Logged in on',a)
...
Press 4 for exit\n''')
    ...
    if user_input1 == '1':
        ...
        print('There currently', BankAccount.no_of_cust,'customers in State Bank of India.')
    elif user_input1 == '4':
        print('Exited')
        break
    else:

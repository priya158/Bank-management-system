...
if __name__ == '__main__':
    ...
    cust1 = BankAccount(name='priya', mobile_no=9148252613, initial_depo=1000, pin=1581)
    cust2 = BankAccount(name='shanvi', mobile_no=9900745256, initial_depo=2000, pin=4101)
